...
import ReusablesView from './components/BMDashboard/Reusables/ReusablesView';
...
const AddReusable = lazy(() => import('./components/BMDashboard/AddReusable/AddReusable'));
  ...
  <Switch>
    ...
    <>
      ...
      <Switch>
        ...
        <BMProtectedRoute path="/bmdashboard/reusables/add" fallback component={AddReusable} />
        ...
        <BMProtectedRoute path="/bmdashboard/reusables" component={ReusablesView} />
