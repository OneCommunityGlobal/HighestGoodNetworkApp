...
function TimeEntry(props) {
  ...
  const editFilteredColor = () => {
    try {
      ...
      const choosenColor = hrsFilterBtnColorMap[[1, 2, 3, 4].includes(daysPast) ? daysPast : 7];
      setFilteredColor(choosenColor);
    } catch (error) {
      // Log the error in a more controlled manner, or remove it if not needed
            ...
            <div className="time-entry-container">
              ...
              <div className="d-flex justify-content-end">
                {(hasATimeEntryEditPermission || isAuthUserAndSameDayEntry) &&
                  !cantEditJaeRelatedRecord && (
                    <button type="button" className="mr-3 text-primary">
