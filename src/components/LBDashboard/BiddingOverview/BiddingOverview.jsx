...
function BiddingOverview() {
  ...
  const unitDetails = {
    ...
    currentBid: '40$',
    unitAmenities: ['Artistic Interiors', 'Artistic Interiors', 'Artistic Interiors'],
    villageAmenities: [
      'Central Tropical',
  ...
  useEffect(() => {
    const fetchUnitDetails = async () => {
      try {
        // Unit details would be fetched from API
      } catch (error) {
  ...
  //   e.preventDefault();
  //   // Replaced alert with console.info.
  //   console.info(`Booking info:
  //     From: ${rentingFrom},
  //     To: ${rentingTo},
  //     Name: ${name},
  //     Bid: ${biddingPrice}`);
            ...
            <div className="bidding-left">
              ...
              <div className="amenities-container">
                <div className="amenities-section">
                  ...
                  <ol>
                    {unitDetails.unitAmenities.map((amenity, index) => (
