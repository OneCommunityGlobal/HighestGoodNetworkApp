...
function ActionDoneGraph({ selectedTeams, teamData }) {
  ...
  if (!teamData || Object.keys(teamData).length === 0) {
    return <div className={styles['no-data-ri']}>No data available for Action Done Graph.</div>;
  }
  ...
  return (
    <div className={styles['ri-action-done-graph']}>
      <h2>PR: Action Done</h2>
      <div className={styles['ri-graph']}>
