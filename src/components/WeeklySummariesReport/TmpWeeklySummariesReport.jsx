...
// function WeeklySummariesReport({ role, error }) {
function WeeklySummariesReport({ props }) {
    ...
    <Container fluid className="bg--white-smoke py-3 mb-5">
      ...
      <Row>
        <Col lg={{ size: 10, offset: 1 }}>
          ...
          <TabContent activeTab={state.activeTab} className="p-4">
