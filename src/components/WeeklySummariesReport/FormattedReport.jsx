...
const FormattedReport = ({ summaries, weekIndex, bioCanEdit }) => {
  ...
  const BioSwitch = (userId, bioPosted, weeklySummaryOption, teamColor, totalTangibleHrs, daysInTeam) => {
      ...
      {alphabetize(summaries).map((summary, index) => {
        ...
        return (
          ...
          >
            ...
            {bioFunction(summary._id, summary.bioPosted, summary.weeklySummaryOption, teamColor, summary.totalTangibleHrs, summary.daysInTeam)}
