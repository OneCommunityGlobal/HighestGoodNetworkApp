...
import { fetchTaskEditSuggestions, rejectTaskEditSuggestion, fetchTaskEditSuggestionCount } from '../thunks';
...
describe('Task Edit Suggestions Thunks', () => {
  ...
  describe('rejectTaskEditSuggestion', () => {
    ...
    // Additional tests for error scenarios can be written here
  });
