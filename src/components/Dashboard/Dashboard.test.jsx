...
vi.mock('../WeeklySummary/WeeklySummary', () => ({ default: () => <div data-testid="weeklysummary" /> }))
vi.mock('../Timelog/Timelog', () => ({ default: () => <div data-testid="timelog" /> }))
vi.mock('../SummaryBar/SummaryBar', () => ({ default: props => <div data-testid="summarybar" data-displayuserid={props.displayUserId} /> }))
vi.mock('./TimeOffRequestDetailModal', () => ({ default: () => <div data-testid="timeoff" /> }))
vi.mock('../FeedbackModal/FeedbackModal', () => ({ default: () => <div data-testid="feedbackmodal" /> }))
