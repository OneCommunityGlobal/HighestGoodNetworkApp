...
//   });
//   const chartData = {
//     labels: lessonsData?.map(item => item.project) || [],
//     datasets: [
//       {
//         label: 'No. of Lessons Learnt',
//         data: lessonsData?.map(item => item.count) || [],
...
//       tooltip: {
//         callbacks: {
//           label: context => 'Click to view the Tags',
//         },
//       },
//       title: {
//         display: false,
...
//                 style={{ left: `${(i + 0.5) * (100 / lessonsData.length)}%` }}
//               >
