...
const PageSizeDropDown = React.memo((props) => {
  return <div className="col-md-2 col-sm-2 col-xs-2">
...
const PageSummaryLabel = React.memo((props) => {
  return <div id="user_table_footer" className="table-summary col-md-4 col-sm-4 col-xs-4 ember-view"
...
const PageLinkItem = React.memo((props) => {
  return <button
    ...
    }} key={'page-' + props.pageNo}>{props.pageNo}</button>;
});
