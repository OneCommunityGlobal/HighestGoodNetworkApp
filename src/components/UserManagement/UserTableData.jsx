...
import { cantUpdateDevAdminDetails, cantDeactivateOwner} from 'utils/permissions';
      ...
      <tr className={`usermanagement__tr ${darkMode ? 'bg-yinmn-blue' : ''}`} id={`tr_user_${props.index}`}>
        ...
        <td>
          <button
            ...
            data-tip={!canAddDeleteEditOwners ? "No permission to do this" : ""}
          >
          ...
          <td>
            ...
            <span className="usermanagement-actions-cell">
              <ResetPasswordButton
                ...
                darkMode={darkMode}
                isSmallButton
                handleClick={e => handleButtonClick(e, () => props.onResetPasswordClick(props.user))}
                data-tip={!canAddDeleteEditOwners ? "No permission to do this" : ""}
              />
            </span>
          </td>
