...
const UserTableSearchHeader = React.memo((props) => {
  ...
  return (
    <tr>
      ...
      <td id="user_first">
        <TextSearchBox id={"firts_name_search"}
          searchCallback={onFirstNameSearch} /></td>
      <td id="user_last_name">
        <TextSearchBox id={"last_name_search"}
          searchCallback={onLastNameSearch} /></td>
      <td id="user_role">
        <DropDownSearchBox id={"role_search"}
          items={props.roles}
          searchCallback={onRoleSearch} />
      </td>
      <td id="user_email">
        <TextSearchBox id={"email_search"}
          searchCallback={onEmailSearch} /></td>
      <td id="user_hrs">
        <TextSearchBox id={"hrs_search"}
          style={{ maxWidth: "75px" }}
          searchCallback={onWeeklyHrsSearch} /></td>
