...
const AddProject = (props) => {
    ...
    return (
        <div className="input-group" id="new_project">
            ...
            <input type="text" className="form-control" aria-label="New Project" placeholder="Project Name (required) type to add." onChange={(e) => changeNewName(e.target.value)} />
            <div className="input-group-append">
                ...
                <div className="input-group-append">
                {showAddButton ?
                    <button className="btn btn-outline-primary" type="button" onClick={(e) => props.addNewProject(newName, newCategory)}>
