...
const UserLinkLayout = props => {
  ...
  return (
    <div data-testid="user-link">
      <p className={darkMode ? 'text-dark' : ''} style={{ display: 'inline-block', marginRight: 10 }}>LINKS </p>
      {props.canEdit ? (
        <LinkModButton userProfile={userProfile} updateLink={updateLink} role={props.role} handleSubmit={handleSubmit} color={darkMode ? "black" : ""}/>
      ) : null}
