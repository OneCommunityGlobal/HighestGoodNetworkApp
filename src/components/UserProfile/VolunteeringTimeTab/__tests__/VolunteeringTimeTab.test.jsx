...
describe('VolunteeringTimeTab Component', () => {
  ...
  it('displays the correct Total Tangible Education Hours', () => {
    renderWithProvider(<VolunteeringTimeTab {...props} />, { store });
  ...
  it('displays the correct Total Tangible Society Hours', () => {
    renderWithProvider(<VolunteeringTimeTab {...props} />, { store });
  ...
  it('displays the correct Total Tangible Energy Hours', () => {
    renderWithProvider(<VolunteeringTimeTab {...props} />, { store });
  ...
  it('displays the correct Total Tangible Food Hours', () => {
    renderWithProvider(<VolunteeringTimeTab {...props} />, { store });
  ...
  it('displays the correct Total Tangible Housing Hours', () => {
    renderWithProvider(<VolunteeringTimeTab {...props} />, { store });
