        ...
        <Container>
          <Row className="mb-3">
            <Col>
              ...
              per year of employment. And we allow the use and scheduling of <span style={{ color: 'green', fontWeight: 500 }}>4</span> a year. Please remove a time-off request below or contact your
