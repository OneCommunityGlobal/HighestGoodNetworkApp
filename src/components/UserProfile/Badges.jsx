...
const Badges = (props) => {
  ...
  <UncontrolledTooltip placement="right" target="FeaturedBadgeInfo" style={{ backgroundColor: '#666', color: '#fff' }}>
    <p className="badge_info_icon_text">Holy Awesome, these are your profiles featured badges !!! Click "Select Featured" to bask in the glory of your COMPLETE LIST!</p>
