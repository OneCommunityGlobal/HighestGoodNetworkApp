        ...
        <Modal.Body>
          <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
            <Form.Label>
              ...
              system system will still issue you a blue square but scheduling here will note this
              reason on it&apos;s clear you chose to use one (vs receiving one for missing
              something) and let us know in advance. Blue squares are meant for situations like this
              and we allow 5 a year.
            </Form.Label>
            <Form.Label>
              <p>
                To schedule your time off, you need to CHOOSE THE SUNDAY OF THE WEEK YOU&apos;LL
                RETURN. This is the date needed so your reason ends up on the blue square that will
                be auto-issued AT THE END OF THE WEEK YOU&apos;LL BE GONE.
              </p>
            </Form.Label>
