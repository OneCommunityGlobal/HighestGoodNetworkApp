...
export const permissionLabels = permissions;
// moved the array of permission objects to separate json file to address code duplication issue from sonarqubecloud bot
