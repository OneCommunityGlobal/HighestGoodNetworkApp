...
const ApplicationTimeChart = () => {
  ...
  console.log('Filters:', { dateFilter, selectedRole });
      ...
      <div style={{ 
        ...
        {processedData.length > 0 && (
          <div style={{
            ...
            <div><strong>Fastest:</strong> {processedData[processedData.length - 1]?.role} ({processedData[processedData.length - 1]?.avgTime} min)</div>
            <div><strong>Slowest:</strong> {processedData[0]?.role} ({processedData[0]?.avgTime} min)</div>
          </div>
        )}
      </div>
