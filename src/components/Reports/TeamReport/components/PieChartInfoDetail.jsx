...
function PieChartInfoDetail({ keyName, value, color, darkMode }) {
  return (
    <div className={styles['pie-chart-info-detail-container']}>
      <div className={styles['pie-chart-info-detail-item']}>
        <div className={styles['pie-chart-legend-color-square']} data-testid="legend-color-square" style={{ backgroundColor: `${color}` }} />
