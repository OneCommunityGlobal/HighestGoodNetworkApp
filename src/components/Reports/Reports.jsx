...
class ReportsPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      showTotalContributors: false,  // Added a new state variable here
      showTotalTeam: false,
  ...
  // Added Contributors Function here !

  showTotalContributors = () => {
    this.setState((prevState) => ({
      showProjects: false,
      showPeople: false,
      showTeams: false,
      ...
      showTotalTeam: false,
      showTotalPeople: false,
      showTotalContributors: !prevState.showTotalContributors, // ✅ Toggle Contributors Report
      showAddTimeForm: false,
      showAddProjHistory: false,
      showAddPersonHistory: false,
      showAddTeamHistory: false,
  ...
  showTotalProject() {
    this.setState({
      ...
      showPeople: false,
      showTeams: false,
      showTotalProject: true,  // Ensuring it is explicitly set to true
      showTotalTeam: false,
      showTotalPeople: false,
      showAddTimeForm: false,
      showAddProjHistory: false,
  ...
  render() {
    ...
    return (
      <Container fluid className={`mb-5 container-component-wrapper ${isOxfordBlue}`}>
        <div
          className={`category-data-container ${isOxfordBlue} ${this.state.showPeople ||
        ...
        >
                ...
                <div className="total-report-container">
                  ...
                  <div>
                    <div className="total-report-item">
                      ...
                      <div className="total-report-item">
                        <Button color="info" onClick={this.showTotalContributors}>
                          {this.state.showTotalContributors ? 'Hide Contributors Report' : 'Show Contributors Report'}
                        </Button>
                        <div style={{ display: 'inline-block', marginLeft: 10 }}>
                          <EditableInfoModal
          ...
          <div className="table-data-container mt-5">
            ...
            {this.state.showTotalContributors && (
              <>
                {console.log("📢 Rendering Contributors Report")}
                <ContributorsReport
                  startDate={this.state.startDate}
                  endDate={this.state.endDate}
                  userProfiles={userProfiles}
