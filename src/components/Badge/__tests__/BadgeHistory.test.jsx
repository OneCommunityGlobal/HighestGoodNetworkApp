...
describe('BadgeHistory component', () => {
    ...
    const mockDataset = [
      {
        ...
        badge: { ranking: 2, badgeName: 'Badge B' },
        count: 1,
      },
      {
        lastModified: '2023-10-10T12:00:00Z',
        badge: { ranking: 0, badgeName: 'Badge A' },
        count: 2,
      },
      {
        lastModified: '2023-10-05T12:00:00Z',
        badge: { ranking: 1, badgeName: 'Badge C' },
        count: 3,
      },
    ];
  ...
  it('filters badges based on time difference', () => {
    const mockDataset = [
      ...
      {
        lastModified: '2023-10-20T12:00:00Z',
        badge: { ranking: 1, badgeName: 'Badge C' },
        count: 3,
      },
    ];
  ...
  it('handles empty dataset', () => {
    ...
    // Expect that no badge images are rendered
