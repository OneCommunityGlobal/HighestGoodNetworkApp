...
const EditBadgePopup = (props) => {
  ...
  useEffect(() => {
    ...
    setProjectName(props.badgeValues ? (props.badgeValues.project ? props.badgeValues.project.projectName : '') : '');
    setProjectId(props.badgeValues ? (props.badgeValues.project ? props.badgeValues.project._id : null) : null);
