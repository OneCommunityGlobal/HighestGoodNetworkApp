...
import {
  Card, CardTitle, CardBody, Button, Modal, ModalBody, ModalHeader, UncontrolledTooltip
} from 'reactstrap';
...
const OldBadges = (props) => {
  ...
  return (
    <>
      ...
      <UncontrolledTooltip placement="right" target="OldBadgeInfo" style={{ backgroundColor: '#666', color: '#fff' }}>
        <p className="badge_info_icon_text">Holy Awesome, these are all the badges you earned before last week!!! Click "Full View" to bask in the glory of your COMPLETE LIST!</p>
