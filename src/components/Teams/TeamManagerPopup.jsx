...
const TeamManagerPopup = React.memo(props => {
  // debugger;
  const closePopup = () => {
    props.onClose();
  };
  ...
  return (
    <Container fluid>
      <Modal isOpen={props.open} toggle={closePopup}>
        <ModalHeader toggle={closePopup}>{`Manager of ${props.selectedTeamName}`}</ModalHeader>
...
export default TeamManagerPopup;
