...
const TeamStatusPopup = React.memo((props) => {
  ...
  return <Modal isOpen={props.open} toggle={closePopup}>
    ...
    <ModalBody style={{ textAlign: 'center' }}>
      ...
      <span>Are you sure you want to change the status of this team " {props.selectedTeamName}"</span><br />
    ...
    <ModalFooter>
      <Button color="danger" onClick={(e) => { props.onConfirmClick(props.selectedTeamName, props.selectedTeamId, !props.selectedStatus) }}>Confirm</Button>
