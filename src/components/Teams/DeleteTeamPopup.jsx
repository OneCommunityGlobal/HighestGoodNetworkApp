  ...
  return (
    <Modal isOpen={props.open} toggle={closePopup}>
      ...
      <ModalFooter>
        ...
        <Button color="danger" onClick={() => { props.onDeleteClick(props.selectedTeamId); }}>Confirm</Button>
        <Button color="warning" onClick={() => { props.onSetInactiveClick(props.selectedTeamName, props.selectedTeamId, false); }}>Set Inactive</Button>
