              ...
              <CardBody>
                ...
                <Alert color="warning" className={styles.insightAlert}>
                  <div className={styles.insightContent}>
                    ...
                    consistent upward trend. Keep up the great work! Notice a dip in Art activities
                    during that period.
                  </div>
                  <div className={styles.insightActions}>
          ...
          <Col>
            <Card className={`${styles.reportCard} ${darkMode ? styles.darkMode : ''}`}>
              <CardBody>
                ...
                <Alert color="warning" className={styles.insightAlert}>
                  <div className={styles.insightContent}>
                    <strong>Actionable Insight:</strong> Consistently applying &apos;Everything you
                    do should increase choices&apos; seems to correlate with positive learning
                  ...
                  <div className={styles.insightActions}>
                    ...
                    <button className={styles.actionButton}>Tips for emotional intelligence</button>
                  </div>
                </Alert>
              </CardBody>
            </Card>
