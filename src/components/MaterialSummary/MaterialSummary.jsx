...
export default function MaterialUsageDashboard() {
  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "16px" }}>
      <h1 style={{ fontSize: "1.875rem", fontWeight: "bold", marginBottom: "24px" }}>Material Usage Dashboard</h1>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          >
            <div style={{ marginBottom: "16px" }}>
              <h2 style={{ fontSize: "1.25rem", fontWeight: "600", marginBottom: "4px" }}>Filters</h2>
              <p style={{ color: "#6b7280", fontSize: "0.875rem" }}>Select options to filter the chart data</p>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              {/* Project Filter */}
              <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                <label htmlFor="project" style={{ display: "block", fontSize: "0.875rem", fontWeight: "500" }}>
                  Project
                </label>
                <select
                  id="project"
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                <label htmlFor="material" style={{ display: "block", fontSize: "0.875rem", fontWeight: "500" }}>
                  Material Type
                </label>
                <select
                  id="material"
          ...
          >
            ...
            {chartData && !loading && (
              <div style={{ marginTop: "24px", borderTop: "1px solid #e5e7eb", paddingTop: "16px" }}>
                <h3 style={{ fontSize: "1.125rem", fontWeight: "500", marginBottom: "12px" }}>Material Breakdown</h3>
                <div
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p style={{ fontSize: "1.5rem", fontWeight: "bold" }}>
                            {value}{" "}
                            <span style={{ fontSize: "0.875rem", color: "#6b7280", fontWeight: "normal" }}>units</span>
                          </p>
                        </div>
                      </div>
                    )
