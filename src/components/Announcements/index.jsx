...
function Announcements({ title, email: initialEmail }) {
  ...
  const tabs = [
    ...
    { id: 'x', label: 'X', customIconSrc: 'social-media-logos/x_icon.webp' },
    { id: 'facebook', icon: faFacebook, label: 'Facebook' },
    { id: 'linkedin', icon: faLinkedin, label: 'LinkedIn' },
    {
      id: 'pinterest',
      label: 'Pinterest',
      customIconSrc: 'social-media-logos/pinterest_icon.webp',
    },
    { id: 'instagram', label: 'Instagram', customIconSrc: 'social-media-logos/insta_icon.webp' },
    { id: 'threads', label: 'Threads', customIconSrc: 'social-media-logos/threads_icon.webp' },
    { id: 'mastodon', label: 'Mastodon', customIconSrc: 'social-media-logos/mastodon_icon.webp' },
    { id: 'bluesky', label: 'BlueSky', customIconSrc: 'social-media-logos/bluesky_icon.webp' },
    { id: 'youtube', label: 'Youtube', customIconSrc: 'social-media-logos/youtube_icon.webp' },
    { id: 'reddit', label: 'Reddit', customIconSrc: 'social-media-logos/reddit_icon.webp' },
    { id: 'tumblr', label: 'Tumblr', customIconSrc: 'social-media-logos/tumblr_icon.webp' },
    { id: 'imgur', label: 'Imgur', customIconSrc: 'social-media-logos/imgur_icon.webp' },
    { id: 'myspace', label: 'Myspace', customIconSrc: 'social-media-logos/myspace_icon.webp' },
    { id: 'medium', icon: faMedium, label: 'Medium' },
    { id: 'plurk', label: 'Plurk', customIconSrc: 'social-media-logos/plurk_icon.webp' },
    {
      id: 'livejournal',
      label: 'LiveJournal',
      customIconSrc: '/social-media-logos/liveJournal_icon.webp',
    },
    { id: 'slashdot', label: 'Slashdot', customIconSrc: '/social-media-logos/slashdot_icon.webp' },
    { id: 'blogger', label: 'Blogger', customIconSrc: '/social-media-logos/blogger_icon.webp' },
    {
      id: 'truthsocial',
      label: 'Truth Social',
      customIconSrc: '/social-media-logos/truthsocial_icon.webp',
    },
