...
export const defaultTemplateData = {
  ...
  footerContent:
    '<p style="text-align: center; margin-bottom: 12px;"><em>In order to change an existing paradigm you do not struggle to try and change the problematic model. You create a new model and make the old one obsolete. That, in essence, is the higher service to which we are all being called.<br />~ Buckminster Fuller ~</em></p><p style="text-align: center; margin-bottom: 24px;"><strong style="color: inherit;">Our Mailing Address is:</strong><br />One Community Inc.<br />8954 Camino Real<br />San Gabriel, CA 91775-1932</p><p style="text-align: center; margin-bottom: 0;">Want to stop receiving these emails?<br /><a href="' +
    getBaseUrl() +
