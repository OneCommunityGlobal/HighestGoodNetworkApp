...
import './ImgurScheduledPostEditor.css';
...
/**
 * Component for displaying and managing scheduled Imgur posts
 *
 * @param {Array} posts - List of scheduled Imgur posts
 ...
 */
function ImgurScheduledPostsEditor({
  posts = [],
  isLoading = false,
  error = '',
  onDeletePost = () => {},
...
export default ImgurScheduledPostsEditor;