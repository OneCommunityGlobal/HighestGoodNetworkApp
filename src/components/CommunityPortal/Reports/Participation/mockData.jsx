...
const eventModes = ['Virtual', 'In-Person'];
  ...
  for (let week = 0; week < 4; week++) {
    for (let t = 0; t < eventTypes.length; t++) {
      ...
      mockEvents.push({
        ...
        category: eventTypes[t],
        eventMode: eventModes[secureRandInt(0, eventModes.length - 1)],
        ...
        rating: secureRandInt(3, 5),
        eventValue: secureRandInt(100, 1000),
...
for (let t = 0; t < 6; t++) {
  ...
  mockEvents.push({
    ...
    category: eventTypes[t % eventTypes.length],
    eventMode: eventModes[secureRandInt(0, eventModes.length - 1)],
    eventDate: eventDate.toISOString(),
    eventTime: formatDisplayTime(eventDate),
