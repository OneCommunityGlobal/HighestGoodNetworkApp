    ...
    <div className={styles.leaderboardRoot}>
      ...
      {leaderBoardData.length !== 0 ? (
        <div>
          ...
          <div
            id="leaderboard"
            className={`${styles['my-custom-scrollbar']} table-wrapper-scroll-y mb-5`}
          >
                          ...
                          <div className="leaderboard-totals-container text-center">
                            ...
                            {viewZeroHouraMembers(loggedInUser.role) && (
                              <span className={styles.leaderboardTotalsTitle}>
                                0 hrs Totals:{' '}
                                {
                                  filteredUsers.filter(user => user.weeklycommittedHours === 0)
                                    .length
                                }{' '}
                                Members
                              </span>
                        ...
                        <tr
                          ...
                          onMouseEnter={
                            darkMode
                              ? e => {
                                  e.currentTarget
                                    .querySelectorAll('td, th, span, p, a')
                                    .forEach(el => {
                                      el.style.color = '#000';
