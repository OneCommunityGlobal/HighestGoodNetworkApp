...
export const SWITCH_THEM_TO_INACTIVE_IF_YOU_LIKE_TO_KEEP_THEM_IN_THE_SYSTEM = 'Switch them to Inactive If you\'d like to keep them in the system';
export const DUE_DATE_MUST_GREATER_THAN_START_DATE = 'Due Date must be greater than Start Date';
export const USER_DELETE_CONFIRMATION_FIRST_LINE = "Are you sure you want to delete this user? This action cannot be undone.";
export const USER_DELETE_CONFIRMATION_SECOND_LINE = "Switch them to 'Inactive' if you'd like to keep them in the system or choose “Keep Data” if you’d like to still delete them but add their associated data to the “Data Archive” instead of completely deleting them and all their data.";
