...
export const getAllTimeOffRequests = () => async (dispatch) => {
  try {
    ...
    dispatch(fetchTimeOffRequestsFailure(error.message || 'Failed to fetch time off requests'));
  }
};
...
export const addTimeOffRequestThunk = (request) => async (dispatch) => {
  try {
    ...
    dispatch(fetchTimeOffRequestsFailure(error.message || 'Failed to add time off request'));
  }
};
...
export const updateTimeOffRequestThunk = (id, data) => async (dispatch) => {
  try {
    ...
    // Removed console.log as per no-console rule
    dispatch(fetchTimeOffRequestsFailure(error.message || 'Failed to update time off request'));
  }
};
...
export const deleteTimeOffRequestThunk = (id) => async (dispatch) => {
  try {
    ...
    // Removed console.log as per no-console rule
    dispatch(fetchTimeOffRequestsFailure(error.message || 'Failed to delete time off request'));
  }
};
