...
export const confirmNonHgnUserEmailSubscription = async (token = '') => {
  ...
  try {
    ...
    // Optionally, you can display a success toast here
    ...
    // Optionally, you can display an error toast here
    // toast.error('Error sending request', {
    //   position: 'top-center',
    //   autoClose: 3000,
    // });
...
export const removeNonHgnUserEmailSubscription = async (email = '') => {
  ...
  try {
    ...
    // Optionally, you can display a success toast here
    // toast.success('Successfully removed email subscription', {
    //   position: 'top-center',
    //   autoClose: 3000,
    // });
    ...
    // Optionally, you can display an error toast here
    // toast.error('Error removing email subscription', {
    //   position: 'top-center',
    //   autoClose: 3000,
    // });
