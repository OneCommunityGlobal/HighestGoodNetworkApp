...
import { GET_TIME_ENTRIES_WEEK } from '../constants/timeEntries';
  ...
  infringments: [
    {
      ...
      date: '2020-06-14',
      description: 'System auto-assigned infringement for two reasons: not meeting weekly volunteer time commitment as well as not submitting a weekly summary. For the hours portion, you logged 0 hours against committed effort of 10 hours in the week starting Sunday 2020-06-07 and ending Saturday 2020-06-13.',
    },
    {
      _id: '5eef0570fa910222687757cf',
      date: '2020-06-21',
      description: 'System auto-assigned infringement for two reasons: not meeting weekly volunteer time commitment as well as not submitting a weekly summary. For the hours portion, you logged 0 hours against committed effort of 10 hours in the week starting Sunday 2020-06-14 and ending Saturday 2020-06-20.',
    },
    {
      _id: '5eef6b49d689503a6fd85e1a',
      date: '2020-06-21',
      description: 'System auto-assigned infringement for not meeting weekly volunteer time commitment. You logged 0 hours against committed effort of 10 hours in the week starting Sunday 2020-06-14 and ending Saturday 2020-06-20',
    },
    {
      _id: '5f13ef74e998840964d5e22a',
      date: '2020-07-19',
      description: 'System auto-assigned infringement for not meeting weekly volunteer time commitment. You logged 0 hours against committed effort of 10 hours in the week starting Sunday 2020-07-12 and ending Saturday 2020-07-18',
    },
    {
      _id: '5f144a62c447e6373cd9c8a0',
      date: '2020-07-19',
      description: 'System auto-assigned infringement for two reasons: not meeting weekly volunteer time commitment as well as not submitting a weekly summary. For the hours portion, you logged 0 hours against committed effort of 10 hours in the week starting Sunday 2020-07-12 and ending Saturday 2020-07-18.',
    },
    {
      _id: '5f266471bd88267c2878dd81',
      date: '2020-08-02',
      description: 'System auto-assigned infringement for not meeting weekly volunteer time commitment. You logged 4 hours against committed effort of 10 hours in the week starting Sunday 2020-07-26 and ending Saturday 2020-08-01',
    },
    {
      _id: '5f2664705caa0d1c58a70a0f',
      date: '2020-08-02',
      description: 'System auto-assigned infringement for two reasons: not meeting weekly volunteer time commitment as well as not submitting a weekly summary. For the hours portion, you logged 4 hours against committed effort of 10 hours in the week starting Sunday 2020-07-26 and ending Saturday 2020-08-01.',
    },
  ],
  role: 'Administrator',
  firstName: 'Dev',
  ...
  weeklySummaries: [
    {
      ...
      summary: '<p>This is a test summary entered for the week ending <strong>Sat. August 8th, 2020</strong>.</p>',
    },
    {
  ...
  weeks: {
    ...
    1: [
      ...
      },
      {
        ...
        notes: '<p>d g g sg sd gs dg ag dg c jh&nbsp;</p>\n<p><a href="https://docs.google.com/document/d/1AQVluo0JNhAsqul-Zv1aNMhjX2eGuHKMCoGcvCI7XU4/edit">https://docs.google.com/document/d/1AQVluo0JNhAsqul-Zv1aNMhjX2eGuHKMCoGcvCI7XU4/edit#</a></p>\n<p>&nbsp;</p>',
        isTangible: true,
        personId: '5edf141c78f1380017b829a6',
        projectId: '5e606e4f37477100173680ac',
        projectName: 'Mock Project 2',
    ...
    2: [
      {
        ...
        notes: '<p>af afs af af af a a fh sc d gfsg sdg <a href="http://www.google.com">http://www.google.com</a></p>',
        isTangible: true,
        personId: '5edf141c78f1380017b829a6',
        projectId: '5a849055592ca46b43db2729',
        projectName: 'Mock Project 4',
      ...
      },
      {
        ...
        notes: '<p>sfa asf as fa scas cas c asc scac c <a href="http://www.google.com">http://www.google.com</a></p>',
        isTangible: true,
        personId: '5edf141c78f1380017b829a6',
      ...
      },
      {
        ...
        notes: '<p>sa swf asf asf asda fa asf asf as f&nbsp;<a href="http://www.google.com">http://www.google.com</a></p>',
        isTangible: true,
        personId: '5edf141c78f1380017b829a6',
        projectId: '5a849055592ca46b43db2729',
        projectName: 'Mock Project 4',
...
describe('<DeleteModal />', () => {
  ...
  it('should render the garbage icon without crashing', () => {
    const component = renderer.create(
      <Provider store={store}>
        <DeleteModal timeEntry={timeEntryMock} />
      </Provider>,
    );
...
describe('<TimeEntryForm />', () => {
  ...
  beforeEach(() => {
    ...
    renderWithProvider(
      <TimeEntryForm userId={data.personId} data={data} />,
      {
        store,
      },
    );
    user.click(screen.getByRole('button', { name: /add time entry/i }));
  });
  it('should dispatch the right action with the right payload after add new time entry', async () => {
    ...
    user.type(screen.getAllByRole('spinbutton')[0], '1');
...
describe('<TimeEntryForm edit/>', () => {
  ...
  beforeEach(() => {
    ...
    user.click(screen.getByRole('img', { hidden: true }));
  });
  afterEach(cleanup);
  ...
  it('should render with the correct placeholder first', () => {
    ...
    expect(screen.getByRole('textbox')).toHaveValue(data.notes);
  });
  ...
  it('should change Project with user input', () => {
    ...
    user.selectOptions(project, userProjectMock.projects[1].projectId);
  ...
  it('should dispatch action when click Save', async () => {
    ...
    timeEntry.notes = `<p>${data.notes}</p>`;
    ...
    await waitForElementToBeRemoved(() => screen.getByText(/edit time entry/i));
  });
});
...
describe('<Timelog/>', () => {
  ...
  it('should switching between tabs after the user clicks the tab', async () => {
    ...
    const lastWeek = screen.getByText(/last week/i);
    const weekBeforeLast = screen.getByText(/week before last/i);
    user.click(currentWeek);
    await sleep(100);
    expect(screen.getByTestId('tab-0')).toHaveClass('tab-pane active');
    expect(screen.getByTestId('tab-1')).toHaveClass('tab-pane');
    expect(screen.getByTestId('tab-2')).toHaveClass('tab-pane');
    user.click(lastWeek);
    await sleep(100);
    expect(screen.getByTestId('tab-1')).toHaveClass('tab-pane active');
    expect(screen.getByTestId('tab-0')).toHaveClass('tab-pane');
    expect(screen.getByTestId('tab-2')).toHaveClass('tab-pane');
    user.click(weekBeforeLast);
    await sleep(100);
    expect(screen.getByTestId('tab-2')).toHaveClass('tab-pane active');
    expect(screen.getByTestId('tab-1')).toHaveClass('tab-pane');
    expect(screen.getByTestId('tab-0')).toHaveClass('tab-pane');
  });
  it('should render filtered project with <select>', async () => {
    ...
    user.selectOptions(projectSelect, userProjectMock.projects[1].projectId);
    expect(screen.getAllByRole('heading', { name: /mock project \d/i })).toHaveLength(2);
    user.selectOptions(projectSelect, userProjectMock.projects[0].projectId);
    expect(screen.queryAllByRole('heading', { name: /mock project \d/i })).toHaveLength(0);
    user.selectOptions(projectSelect, userProjectMock.projects[3].projectId);
