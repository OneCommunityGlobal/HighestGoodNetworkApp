...
export const roleReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.RECEIVE_ROLES:
      const rolesSortByPermission = action.roles.sort((a,b)=> b.permissions.length - a.permissions.length);
    ...
    case types.UPDATE_ROLE:
      ...
      const indexRoleUpdated = state.roles.findIndex((role) => role.roleName === roleUpdated.roleName)
