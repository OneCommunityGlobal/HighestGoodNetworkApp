...
export const FIND_PROJECT_MEMBERS_START = 'FIND_PROJECT_MEMBERS_START';
export const FOUND_PROJECT_MEMBERS = 'FOUND_PROJECT_MEMBERS';
export const FIND_PROJECT_MEMBERS_ERROR = 'FIND_PROJECT_MEMBERS_ERROR';
...
export const FETCH_PROJECTS_ACTIVE_USERS_SUCCESS = 'FETCH_PROJECTS_ACTIVE_USERS_SUCCESS';
export const FETCH_PROJECTS_ACTIVE_USERS_ERROR = 'FETCH_PROJECTS_ACTIVE_USERS_ERROR';
