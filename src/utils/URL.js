...
export const ENDPOINTS = {
  ...
  UPDATE_ALL_USER_PROFILES_INFO_COLLECTIONS: `${APIEndpoint}/userprofile/updateAll/infoCollections`,
  ...
  // INFOS: () => `${APIEndpoint}/infos`,
  // INFOS_BY_ID: infoId => `${APIEndpoint}/infos/${infoId}`,
